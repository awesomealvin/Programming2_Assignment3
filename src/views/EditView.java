...
public class EditView extends JPanel {
	...
	public EditView(Movie movie) {
		...
		textFieldTitle = new JTextField(movie.getTitle());
		...
		textFieldDirector = new JTextField(movie.getDirector());
		...
		textFieldYear = new JTextField(Integer.toString(movie.getYear()));
		...
		textFieldRating = new JTextField(Double.toString(movie.getRating()));
		...
		buttonConfirm = new JButton("Confirm Changes");
		buttonConfirm.setBounds(336, 179, 150, 26);
		add(buttonConfirm);
		
		buttonDiscard = new JButton("Discard Changes");
